tinymce.ThemeManager.add('mecha', function(editor) {
    var self = this,
    ...
    var defaultMenus = {
        ...
        format: {
            title: "Format",
            items: "bold italic underline strikethrough code superscript subscript | formats | removeformat"
        },
        tools: {
            title:"Tools"
        },
    ...
    var defaultToolbar = "bold italic";
    /**
